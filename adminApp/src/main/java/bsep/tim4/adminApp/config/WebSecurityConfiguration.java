...
public class WebSecurityConfiguration extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/api/certificate/download/*").permitAll()
                .antMatchers("/api/hospital").hasAnyRole("SUPER_ADMIN")
                .antMatchers("/api/hospital/*").hasAnyRole("SUPER_ADMIN")
                .antMatchers("/api/hospital/not-in/*").hasAnyRole("SUPER_ADMIN")
                .antMatchers("/api/hospital/add-simulator/*").hasAnyRole("SUPER_ADMIN")
